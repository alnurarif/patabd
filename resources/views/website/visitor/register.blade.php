  ...
  <div class="container">
    ...
    <div class="tt">
      <ul  class="nav nav-pills">
        <li class="active">
          <li>
            <a href="#1a" data-toggle="tab" style="padding: 10px 55px;">For Visitor</a>
          <a  href="#2a" data-toggle="tab" style="padding: 10px 55px;">For Landloard</a>
        </li>
        </li>
        ...
        <div class="login_right">
          ...
          <h3>Please Visitor SignUp Here</h3>
          <form method="post" action="{{url('/visitor/create')}}">
            @csrf
          ...
          <h3>Please Landlord SignUp Here</h3>
