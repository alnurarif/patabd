...
<head>
  ...
  <title>Patabd - Dashboard</title>

  <!-- Custom fonts for this template-->
  <link href="{{asset('contents/admin')}}/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">

  <!-- Page level plugin CSS-->
  <link href="{{asset('contents/admin')}}/vendor/datatables/dataTables.bootstrap4.css" rel="stylesheet">
...
<body id="page-top">
  ...
  <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
    ...
    <a class="navbar-brand mr-1" href="index.html">Patabd Dashboard</a>
    ...
    <ul class="sidebar navbar-nav">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          ...
          <a class="dropdown-item" href="{{url('admin/alluser')}}">All User</a>
          <a class="dropdown-item" href="{{url('admin/adduser')}}">Register</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Website user:</h6>
          <a class="dropdown-item" href="{{url('/admin/all/landlord')}}">Landlord user</a>
          <a class="dropdown-item" href="{{url('admin/approve/list')}}">Visitor user list</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="pagesDropdown">
          <h6 class="dropdown-header">Room List:</h6>
          <a class="dropdown-item" href="{{url('/admin/room/list')}}">Panding</a>
          <a class="dropdown-item" href="{{url('admin/approve/list')}}">Approve list</a>
          <a class="dropdown-item" href="{{url('admin/cancel/list')}}">Cancel list</a>
          <div class="dropdown-divider"></div>
        </div>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="{{url('admin/all/about')}}">
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/admin/all/contact')}}">
          <i class="fas fa-fw fa-chart-area"></i>
      ...
      <li class="nav-item">
        <a class="nav-link" href="{{url('/admin/all/privacy')}}">
          <i class="fas fa-fw fa-chart-area"></i>
...
@yield('content')
  ...
  <script src="{{asset('contents/admin')}}/vendor/datatables/dataTables.bootstrap4.js"></script>

  <!-- Custom scripts for all pages-->
  <script src="{{asset('contents/admin')}}/js/sb-admin.min.js"></script>

  <!-- Demo scripts for this page-->
  <script src="{{asset('contents/admin')}}/js/demo/datatables-demo.js"></script>
