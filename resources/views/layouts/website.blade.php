...
<html class="no-js" lang="">
    <head>
        ...
        <title>Welcome To Pata BD</title>
        <meta name="csrf-token" content="{{ csrf_token() }}">
        <meta name="description" content="">
        <meta name="viewport" content="width=device-width, initial-scale=1">

        <link rel="manifest" href="site.webmanifest">
    <link rel="shortcut icon" type="image/x-icon" href="{{asset('contents/website')}}/img/favicon.ico">
        <!-- Place favicon.ico in the root directory -->
        <base data-base="{{url('/')}}"></base>
    <!-- CSS here -->
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('contents/website')}}/css/shopping_card.css">
        <link rel="stylesheet" type="text/css" href="{{asset('contents/website')}}/css/starability-all.min.css">
        <link rel="stylesheet" href="{{asset('contents/website')}}/css/default.css">
        <link rel="stylesheet" href="{{asset('contents/website')}}/css/style.css">
        <link rel="stylesheet" href="{{asset('contents/website')}}/css/ex.css">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="{{asset('contents/website')}}/img/logo.png" alt="logo image">
                                </a>
                            </div>
                        </div>
                        <div class="col-md-8">
                            ...
                            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                              ...
                              <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                                <div class="navbar-nav">
                                  ...
                                  @if($landloard)
                                  <a class="nav-item nav-link active" href="{{url('/listUrRoom')}}">List Room <span class="sr-only">(current)</span></a>
                                  @endif
                                  <a class="nav-item nav-link active" href="{{url('/contact')}}">Contact <span class="sr-only">(current)</span></a>
                              ...
                              @if($visitor)
                                  <div class="header_t_card">
                                      ...
                                      <a href="login.html">{{$visitor->f_name}} {{$visitor->l_name}}</a>
                                      <i class="fas fa-user"></i>
                                      <a href="{{url('visitor/logout')}}">logout</a>
                                  </div>
                                @else
                                  ...
                                  <i class="fas fa-user"></i>
                                  &nbsp
                                  <a href="{{url('/visitor/login_form')}}">Login </a>
                                  <i class="fas fa-user"></i>
                                  &nbsp
                                  <a href="{{url('visitor/register')}}">SignUp</a>

                                  @endif
                              @if($landloard)
                                  <div class="header_t_card">
                                      <i class="fas fa-user"></i>
                                      <a href="login.html">{{$landloard->f_name}} {{$landloard->l_name}}</a>
                                      <i class="fas fa-user"></i>
                                      <a href="{{url('landloard/logout')}}">logout</a>
                                  </div>
...
<footer id="footer_section">
 <div class="footer_bg">
    ...
    <div class="row">
      <div class="col-md-12">
        <h2>Best Hotel Booking Platform in Bangladesh</h2>
      </div>
    </div>
    ...
    padding-bottom: 28px">
      <div class="col-md-4">
        <div class="footer_content">
          <h3>Download PataBD app for exciting offers.</h3>
          <img src="{{asset('contents/website')}}/img/Screenshot_6.png">
          <img src="{{asset('contents/website')}}/img/Screenshot_7.png">
        </div>
      </div>
      <div class="col-md-4">
          <div class="content_menu">
            <ul>
              ...
              <li><a href="{{url('/terms')}}">Teams & Conditions</a></li>
      ...
      <div class="col-md-4">
        <div class="content_menu">
            <ul>
              <li><a href="{{url('/blog')}}">Official PataBD Blog</a></li>
...
function updateInputs (data) {
    from = data.from;
    to = data.to;
    $('#room_price_from').html(from);
    $('#room_price_to').html(to);
...
$inputTo.on("input", function () {
  ...
  <!-- JS here -->
    ...
    <!-- Rating End -->
        ...
        <script src="{{asset('contents/website')}}/js/one-page-nav-min.js"></script>
        ...
        <script src="{{asset('contents/website')}}/js/ajax-form.js"></script>
        ...
        <script src="{{asset('contents/website')}}/js/rating.js"></script>
        <script src="{{asset('contents/website')}}/js/jquery.cookie.js"></script>
    
        <!-- CSS here -->
        @yield('additional_footer_script')
